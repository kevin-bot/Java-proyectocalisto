...
public class EditarDocente extends javax.swing.JDialog {
     ...
     */
    public EditarDocente(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(btneditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 290, 140, 40));

        jButton1.setText("Eliminar ");
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 290, 110, 40));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EditarDocente dialog = new EditarDocente(new javax.swing.JFrame(), true);
